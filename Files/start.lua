...
type = 'inline',
data = {
{{text = '• سۅࢪس تيبثون •',url="t.me/Tepthonee"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '◉ :  لتفعيل بوت هنا .',url="t.me/PPF22"}},
}
}
...
local UserId_Info = bot.searchPublicChat("PPF22")
if UserId_Info.id then
...
{{text = '◉ :  𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/Tepthonee"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '• سۅࢪس تيبثون •',url="https://t.me/Tepthonee"}},
}
}
...
return bot.sendText(msg.chat_id,msg.id, "• المهر لازم اكثر من 1000 دينار 💸\n","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "عشان تخلعينه لازم تجمعين "..mhrr.." دينار\n-","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح هو 200 دينار 💸\n-","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
...
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
return bot.sendText(msg.chat_id,msg.id,"• خذ بخشيش المحظوظين 3000 دينار 💸","md",true)
end
local jjjo = math.random(1,2000);
redis:incrby(bot_id.."nool:flotysb"..msg.sender.user_id , jjjo)
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
bot.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دينار 💸","md",true)
...
return bot.sendText(msg.chat_id,msg.id, "• مايمديك تسرقهه فلوسه اقل من 2000  دينار 💸","md",true)
end
...
bot.sendText(msg.chat_id,msg.id, "• خذ يالحرامي سرقهته "..hrame.." دينار 💸\n","md",true)
...
local Text = "*◉ :  WeLCoMe To 𝑆𝑂𝐔𝑅𝐶𝐸 𝑇𝐸𝑃𝑇𝐻𝑂𝑁  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• سۅࢪس تيبثون •',url="https://t.me/Tepthonee"}},
{{text = '◉ :  inFo 𝑇𝐸𝑃𝑇𝐻𝑂𝑁 .',url="https://t.me/Tepthonee"}},
{{text = '◉ :  CoDeR .',url="https://t.me/PPF22"},{text = '◉ :  TwS .',url="https://t.me/PPF22"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/photo_mas/5&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
