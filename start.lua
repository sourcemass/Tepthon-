...
is_personal = true,
data = {
{{text ='‹  ايقاف/حذف بوت ›',type = 'text'},{text = '‹  انشاء بوت مجاني ›',type = 'text'}},
{{text = '‹  معلومات عن البوت ›',type = 'text'}},
}
}
...
if text == "/start" then 
local bl = '*◾أهلا بك في صانع بوتات الحمايه 👋🏻 ،\n\n◽البوت مقدم من قناة »* [. 𝖲𝗈𝗎𝗋𝖼𝖾 Tepthone TeAm >](t.me/Tepthone) \n\n*◾يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[⚙️꒐ Gruop The Suport Maker .](https://t.me/Tepthone_Support)'
...
- تم انشاء الصانع مقدم من قناة ( @Tepthone ) مجاناً 
